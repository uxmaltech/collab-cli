...
export function agentEnvTemplate(options: AgentBootstrapOptions): string {
  ...
  const defaults = {
    ...
    COLLAB_RUNTIME_GITHUB_APP_ID: options.githubAppId,
    COLLAB_RUNTIME_GITHUB_APP_INSTALLATION_ID: options.githubAppInstallationId,
    COLLAB_RUNTIME_GITHUB_APP_OWNER: options.githubAppOwner,
    COLLAB_RUNTIME_GITHUB_APP_OWNER_TYPE: options.githubAppOwnerType,
    COLLAB_RUNTIME_GITHUB_APP_PRIVATE_KEY: existing.COLLAB_RUNTIME_GITHUB_APP_PRIVATE_KEY ?? '',
    COLLAB_RUNTIME_GITHUB_APP_PRIVATE_KEY_PATH: options.githubAppPrivateKeyPath,
