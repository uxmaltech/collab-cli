const SKILL_LINES = [
  ...
  'Make the operator roster explicit: capture one or more stable operator ids and keep the primary operator first.',
  ...
  'Treat Telegram as required operational infrastructure for the agent birth, and capture non-secret routing details when relevant.',
  'Do not ask for raw secrets such as bot tokens or API keys in the LLM conversation; the CLI will collect them locally.',
